...
0. SD-Karte auf FAT32 formatieren (geht einfachst mit dem Raspberry-Pi-Imager):
   ...
   4. **Nachdem man sichergestellt hat, dass der richtige Datenträger ausgewählt ist** muss man nun nur noc auf 'Format' klicken, um die SD-Karte zu formatieren
   5. Damit ist nun die SD-Karte mit FAT32 formatiert - dies ist notwendig, da der ESP32S3 nur FAT32 als Dateisystem ansprechen kann
